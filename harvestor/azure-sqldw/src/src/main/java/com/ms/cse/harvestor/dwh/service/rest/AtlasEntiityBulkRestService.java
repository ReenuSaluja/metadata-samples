...
public class AtlasEntiityBulkRestService {
		...
		try {
			...
			URL url = new URL(Constants.ATLASENTITYBULKSERIVCE);
			...
			os.flush();
			System.out.println("Inside AtlasEntiityBulkRestService - > postFunc - > inputBody- >" );
			System.out.println(input);
